...
public class AcaoAgendada implements ScheduledAction {
	...
	public void onTime(ScheduledActionContext ctx) {
		...
		try {
			...
			enviarEmail("Teste Ação Agendada", mensagem, "guilhermeneto@gigantaolocadora.com.br");
	...
	private static String usingBufferedReader() {
		...
		InputStream is = AcaoAgendada.class.getResourceAsStream("email.txt");
