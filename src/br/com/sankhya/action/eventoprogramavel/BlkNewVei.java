...
public class BlkNewVei implements EventoProgramavelJava {// Eclipse -> Github @guilhermeNetogit passou aqui em 11/01/2026 15:26:45
   ...
   public void afterInsert(PersistenceEvent arg0) throws Exception {
	...
	public void beforeUpdate(PersistenceEvent arg0) throws Exception {
        ...
        // Adiciona uma mensagem de aviso (aparece em amarelo no topo da tela)
			throw new Exception(//MGEModelException(
            "Atenção:<br><br>"
			+ "O veículo possui ano de fabricação anterior a 2020.<br>"
            + "Verifique se isso está correto antes de prosseguir.<br><br>"
            + "Teste via Evento Modulo Java/Github 5.");
